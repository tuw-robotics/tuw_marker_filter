...
private:
    ...
    ros::Subscriber sub_fiducial_;                          /// Subscriber to the fiducial detection
    ...
    void callbackFiducial ( const sensor_msgs::FiducialDetection& );                                    /// callback function to execute on incoming fiducial data
